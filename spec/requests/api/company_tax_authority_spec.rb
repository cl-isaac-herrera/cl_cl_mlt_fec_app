...
RSpec.describe 'Api::Companies::TaxAuthorityController', type: :request do
  ...
  # Las cinco claves de la sección. Son el contrato entre el `GET` y el `PATCH`
  ...
  # entera. Ninguna de las dos acciones habla con SAP — es pura columna local.
  ...
  def get_section
    get "/api/companies/#{acme.id}/tax_authority"
  end
  ...
  describe 'GET /api/companies/:company_id/tax_authority' do
    describe 'autorización' do
      ...
      it 'responde 404 con un id que no existe' do
        ...
        get '/api/companies/999999/tax_authority'
      ...
      it 'responde 404 con una compañía fuera de su alcance' do
        ...
        get "/api/companies/#{ajena.id}/tax_authority"
    ...
    describe 'lectura' do
      ...
      it 'devuelve las cinco claves de la sección' do
        get_section
      ...
      it 'informa si hay un secreto guardado, sin decir cuál' do
        get_section
  ...
  describe 'PATCH /api/companies/:company_id/tax_authority' do
    describe 'autorización' do
      it 'responde 401 sin sesión' do
    ...
    # El PATCH devuelve las mismas cinco claves que el `GET`. No es automático
    # —la lista de arriba se mantiene a mano— pero deja el contrato en un solo
    # lugar y falla si alguno de los dos lados deja de exponer un campo (ver
    # también "lectura" en el describe del `GET`, más arriba).
    describe 'contrato con la lectura' do
      before { sign_in_with('Configurations_Companies_Update') }

      it 'devuelve las mismas cinco claves que el GET' do
        patch_section(file: uploaded_file(p12_bytes), CertPin: pin,
