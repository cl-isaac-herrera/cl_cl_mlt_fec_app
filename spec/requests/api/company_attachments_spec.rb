...
RSpec.describe 'Api::Companies::AttachmentsController', type: :request do
  ...
  # Las dos claves de la sección. Son el contrato entre el `GET` y el `PATCH`
  ...
  def get_section
    get "/api/companies/#{acme.id}/attachments"
  end
  ...
  describe 'GET /api/companies/:company_id/attachments' do
    describe 'autorización' do
      ...
      it 'responde 404 con un id que no existe' do
        ...
        get '/api/companies/999999/attachments'
      ...
      it 'responde 404 con una compañía fuera de su alcance' do
        ...
        get "/api/companies/#{ajena.id}/attachments"
    ...
    describe 'lectura' do
      ...
      it 'devuelve las dos claves de la sección' do
        get_section
      ...
      it 'devuelve el nombre y nunca la ruta' do
        get_section
  ...
  describe 'PATCH /api/companies/:company_id/attachments' do
    describe 'autorización' do
      it 'responde 401 sin sesión' do
    ...
    # El PATCH devuelve las mismas dos claves que el `GET`. No es automático
    # —la lista se mantiene a mano— pero deja el contrato en un solo lugar y
    # falla si alguno de los dos deja de exponer un campo (ver también
    # "lectura" en el describe del `GET`, más arriba).
    describe 'contrato con la lectura' do
      before { sign_in_with('Configurations_Companies_Update') }

      it 'devuelve las mismas dos claves que el GET' do
        patch_section(Logo: logo_upload, PrintFormat: format_upload)
