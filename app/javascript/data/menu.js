export default [
  ...
  },
  {
    ...
    nodes: [
      ...
      { key: 'udfs',             label: 'Campos definidos por usuario',   route: '/configurations/udfs',           requiredPermission: 'S_Udfs', requiredCompanyFlag: 'UseFactProv', requiresCompany: true },
      { key: 'users',            label: 'Usuarios',                       route: '/configurations/users',          requiredPermission: 'Configurations_Users_ListAccess' },
      { key: 'numbering',        label: 'Numeración',                     route: '/configurations/numbering',      requiredPermission: 'S_Numbering', requiresCompany: true },
      { key: 'Rol',              label: 'Seguridad',                      route: '/configurations/security',       requiredPermission: 'Configurations_Security_Access' },
      { key: 'sucursal',         label: 'Sucursal',                       route: '/configurations/branches',       requiredPermission: 'S_Sucursal', requiresCompany: true },
